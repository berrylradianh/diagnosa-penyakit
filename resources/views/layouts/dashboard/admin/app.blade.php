        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    <a href="{{ route ('dashboard-admin') }}" class="nav-link"> Diagnosa Penyakit Pisang - Forward Chaining </a>
                </li>
            </ul>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{ route ('penyakit-admin.index') }}" data-active="{{($title == 'Penyakit | Diagnosa Penyakit') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route ('gejala-admin.index') }}" data-active="{{($title == 'Gejala | Diagnosa Penyakit') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route ('rule-admin.index') }}" data-active="{{($title == 'Rule | Diagnosa Penyakit') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
